...
namespace EventDriven.Project.UI
{
    public partial class FormPayment : Form
    {
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            DialogResult result = MessageBox.Show("Payment Received. Do you want to print the receipt?", "Transaction Success", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            g.DrawString("₱" + total.ToString(), new Font("Arial", 14, FontStyle.Bold), Brushes.Black, new PointF(580, y + 60));
            g.DrawString("₱" + total.ToString(), new Font("Arial", 14, FontStyle.Bold), Brushes.Black, new PointF(580, y + 90));


            g.DrawString("End of Report", new Font("Arial", 10, FontStyle.Italic), Brushes.Gray, new PointF(100, y + 150));
        }
